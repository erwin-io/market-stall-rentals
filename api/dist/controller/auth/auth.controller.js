...
let AuthController = class AuthController {
    ...
    async registerTenant(createUserDto) {
        const res = {};
        try {
    ...
    async loginTenant(loginUserDto) {
        const res = {};
        try {
...
__decorate([
    ...
    __metadata("design:paramtypes", [register_dto_1.RegisterTenantUserDto]),
