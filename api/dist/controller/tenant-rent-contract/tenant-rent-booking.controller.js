...
let TenantRentBookingController = class TenantRentBookingController {
    ...
    async create(tenantRentBookingDto) {
        ...
        try {
            ...
            res.success = true;
            res.message = `Tenant Rent Booking ${api_response_constant_1.SAVING_SUCCESS}`;
            return res;
        }
        catch (e) {
            res.success = false;
    ...
    async update(tenantRentBookingCode, dto) {
        ...
        try {
            ...
            res.success = true;
            res.message = `Tenant Rent Booking ${api_response_constant_1.UPDATE_SUCCESS}`;
            return res;
        }
        catch (e) {
            res.success = false;
    ...
    async updateStatus(tenantRentBookingCode, dto) {
        const res = {};
        try {
            res.data = await this.tenantRentBookingService.updateStatus(tenantRentBookingCode, dto);
            res.success = true;
            res.message = `Tenant Rent Booking status ${api_response_constant_1.UPDATE_SUCCESS}`;
            return res;
        }
        catch (e) {
            res.success = false;
...
__decorate([
    (0, common_1.Put)("/updateStatus/:tenantRentBookingCode"),
    __param(0, (0, common_1.Param)("tenantRentBookingCode")),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, tenant_rent_booking_update_dto_1.UpdateTenantRentBookingStatusDto]),
    __metadata("design:returntype", Promise)
], TenantRentBookingController.prototype, "updateStatus", null);
