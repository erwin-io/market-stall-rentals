...
export class OneSignalNotificationService {
  ...
  async sendToExternalUser(
    ...
    let large_icon;
    if (type === "TENANT_RENT_BOOKING") {
      large_icon = this.config.get<string>(
        "ONE_SIGNAL_NOTIF_IMAGE_TENANT_RENT_BOOKING"
      );
    } else if (type === "TENANT_RENT_CONTRACT") {
      large_icon = this.config.get<string>(
        "ONE_SIGNAL_NOTIF_IMAGE_TENANT_RENT_CONTRACT"
      );
    } else if (type === "TENANT_RENT_BILLING_REMINDER") {
      large_icon = this.config.get<string>(
        "ONE_SIGNAL_NOTIF_IMAGE_TENANT_RENT_BILLING_REMINDER"
      );
    } else {
